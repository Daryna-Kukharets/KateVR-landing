...
var _changeLangJs = require("./components/changeLang.js");
var _chooseSelectJs = require("./components/chooseSelect.js");
var _closeOrderJs = require("./components/closeOrder.js");
var _formValidationJs = require("./components/formValidation.js");
var _moveLabelJs = require("./components/moveLabel.js");
var _openFaqJs = require("./components/openFaq.js");
var _playVideoJs = require("./components/playVideo.js");
var _swiperJs = require("./components/swiper.js");
var _toggleListJs = require("./components/toggleList.js");
"use strict";
document.addEventListener("DOMContentLoaded", ()=>{
    (0, _playVideoJs.playVideo)();
    (0, _swiperJs.aboutSlider)();
    (0, _swiperJs.headerSlider)();
    (0, _changeLangJs.changeLang)();
    (0, _toggleListJs.toggleList)();
    (0, _openFaqJs.openFaq)();
    (0, _chooseSelectJs.chooseSelect)();
    (0, _chooseSelectJs.closeDropdown)();
    (0, _moveLabelJs.moveLabel)();
    (0, _formValidationJs.formValidation)();
    (0, _closeOrderJs.closeOrder)();
});

},{"./components/changeLang.js":"j0KMn","./components/chooseSelect.js":"iNd9w","./components/closeOrder.js":"5Dljr","./components/formValidation.js":"2Qh99","./components/moveLabel.js":"9uNqA","./components/openFaq.js":"1oa5d","./components/playVideo.js":"ewPV2","./components/swiper.js":"2Ir1S","./components/toggleList.js":"4XG2g"}],"j0KMn":[function(require,module,exports) {
...
function changeLang() {
    langItems.forEach((item)=>{
        item.addEventListener("click", ()=>{
            ...
            const languageItemChosen = findChosenLang([
                ...languageItems
            ], item);
    ...
    languageItems.forEach((item)=>{
        item.addEventListener("click", ()=>{
            changeLangHandler(item);
            const langItemChosen = findChosenLang([
                ...langItems
            ], item);
            if (langItemChosen) {
                resetActiveLinks();
...
},{}],"iNd9w":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "closeDropdown", ()=>closeDropdown);
parcelHelpers.export(exports, "chooseSelect", ()=>chooseSelect);
...
function closeDropdown() {
    document.addEventListener("click", (e)=>{
        if (!order.contains(e.target)) countList.classList.remove("count__list--active");
        if (!country.contains(e.target)) countriesList.classList.remove("countries__list--active");
        if (!city.contains(e.target)) {
            cityList.classList.remove("city__list--active");
            if (citySelect.textContent.length === 0) cityLabel.style.color = "";
        }
    });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5Dljr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "closeOrder", ()=>closeOrder);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2Qh99":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function formValidation() {
    ...
    const imageBox = document.querySelector(".order__main-desktop");
    const complete = document.querySelector(".complete");
    (0, _imaskDefault.default)(inputCard, {
        mask: "0000 0000 0000 0000"
    });
    (0, _imaskDefault.default)(inputCardDate, {
        mask: "00 / 00"
    });
    (0, _imaskDefault.default)(inputCvv, {
        mask: "000"
    });
    ...
    function inputValidation(inputElement) {
        ...
        if (!inputElement.value.trim()) {
            errorAction(inputElement, label, `Please, fill your ${normalizeName(inputElement.name)}*`);
            error = true;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1oa5d":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "openFaq", ()=>openFaq);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ewPV2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "playVideo", ()=>playVideo);
function playVideo() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2Ir1S":[function(require,module,exports) {
/* eslint-disable no-new */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "aboutSlider", ()=>aboutSlider);
...
var _navigationMinCss = require("swiper/modules/navigation.min.css");
var _scrollbarMinCss = require("swiper/modules/scrollbar.min.css");
const aboutSlider = ()=>{
...
const headerSlider = ()=>{
    new (0, _swiperDefault.default)(".header__slider", {
        modules: [
            (0, _modules.Navigation),
            (0, _modules.Scrollbar),
            (0, _modules.Autoplay)
...
},{"swiper":"iM6UL","swiper/modules":"9ktz6","swiper/swiper.min.css":"eFTGe","swiper/modules/pagination.min.css":"jHq3j","swiper/modules/navigation.min.css":"lN5mV","swiper/modules/scrollbar.min.css":"h5xMP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iM6UL":[function(require,module,exports) {
/**
 * Swiper 11.2.6
...
function loopFix(_temp) {
    ...
    const gridEnabled = swiper.grid && params.grid && params.grid.rows > 1;
    if (slides.length < slidesPerView + loopedSlides || swiper.params.effect === "cards" && slides.length < slidesPerView + loopedSlides * 2) (0, _utilsMjs.u)("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters");
...
},{"../shared/create-shadow.mjs":"bWkQq","../shared/effect-init.mjs":"88TTi","../shared/effect-target.mjs":"3jkAD","../shared/effect-virtual-transition-end.mjs":"dzFvU","../shared/utils.mjs":"9mU7V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eFTGe":[function() {},{}],"jHq3j":[function() {},{}],"lN5mV":[function() {},{}],"h5xMP":[function() {},{}],"4XG2g":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "toggleList", ()=>toggleList);
const langButton = document.querySelector(".select__button");
const langList = document.querySelector(".select__list");
function toggleList() {
...
function toggleListHandler(elementClick, elementList, activeClass) {
    ...
    document.addEventListener("click", (event)=>{
        if (!langButton.contains(event.target) && !elementList.contains(event.target)) elementList.classList.remove(activeClass);
    });
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8bDoD","3cYfC"], "3cYfC", "parcelRequire4cc0")
